...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="img/argon/apple-icon.png">
  ...
  <link href="css/argon/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="css/argon/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show bg-gray-100">
      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="./pages/rtl.html">
              ...
              <span class="nav-link-text ms-1">Loogbook</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./pages/rtl.html">
  ...
  <script src="js/argon/plugins/perfect-scrollbar.min.js"></script>
  <script src="js/argon/plugins/smooth-scrollbar.min.js"></script>
  <script src="js/argon/plugins/chartjs.min.js"></script>
  <script>
  ...
  <script src="js/argon/argon-dashboard.min.js?v=2.0.4"></script>
</body>
